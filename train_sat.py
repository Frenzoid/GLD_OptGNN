...
for model, r, lift_layers, problem in product(models ,r_values, lift_layers_values,  problems):
    ...
    for dataset in datasets:
        ...
        print(f"Running: {model} {dataset} R={r} Layers={lift_layers}  Prefix={prefix}")
